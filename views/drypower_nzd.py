...
def run():
    ...
    fig.update_layout(
        title="Dry Power Indicator (6N=F)",
    ...
    # Description
    st.title("Dry Power Indicator for NZ Dollar Futures (6N=F)")
    st.subheader("From 2015 to 2025")
    st.markdown(
        """
        This chart shows a classic DP indicator for NZ Dollar futures. The individual long and 
