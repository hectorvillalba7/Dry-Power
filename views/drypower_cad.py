...
def run():
    ...
    cad_info = pd.read_excel('assets/dea_fut_cad.xlsx')
    ...
    # Description
    st.title("Dry Power Indicator for Canadian Dollar Futures (6C=F)")
    st.subheader("From 2015 to 2025")
    st.markdown(
        """
        This chart shows a classic DP indicator for Canadian Dollar futures. The individual long and 
