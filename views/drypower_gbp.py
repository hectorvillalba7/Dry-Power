...
def run():
    ...
    fig.update_layout(
        title="Dry Power Indicator (6B=F)",
    ...
    # Description
    st.title("Dry Power Indicator for Euro Futures (6B=F)")
    st.subheader("From 2015 to 2025")
    st.markdown(
        """
        This chart shows a classic DP indicator for Pound futures. The individual long and 
